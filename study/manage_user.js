...
// 4000번 포트를 열고, 화살표 함수 실행 (포트번호 4000번 실행 콘솔로 출력)

// server.use('/', (req, res) => {
//   // res.send('hi');
//   console.log('hi');
// });
// 4000번 포트로 접근 시 hi를 응답해줌
// res.send는 console.log와 다르다 (res.send는 요청에 응답을 해주는 함수)
// 위의 server.use는 4000번 포트 접근 요청시 res.send로 hi를 보내줌
